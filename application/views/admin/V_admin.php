...
<div class="container">
                    ...
                    <nav  aria-label="breadcrumb">
						...
						<div class="post__itam">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <h2 class="text-left"><b>DATA ADMINISTRATOR</b></h2>
                                </div>
                                    <div class="col-lg mb" style="margin-left:200px; margin-bottom:15px;">

                                    <a style="color:white;" href="<?php echo base_url('admin/data_admin');?>" style="margin-right: 10px ;" class="btn btn-warning"><span class='fa fa-refresh' aria-hidden='true'></span> Refresh</a>
                                    </div>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a style="color:#fff;" href="<?=base_url()?>admin/hapus_admin/<?=$key['id_user'];?>" style="border-radius:0px;" class="btn btn-sm btn-danger my-2 my-sm-0 ml-1" type="submit" name="delete" onclick="return confirm('Yakin ingin menghapus data ini ?')"><span class='fa fa-trash' aria-hidden='true'></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>

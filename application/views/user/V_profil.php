  ...
  <ol style="background-color:white;" class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">Profil Saya</a></li>
		...
		<div class="post__itam">
            ...
            <strong><i class="fa fa-exclamation-triangle"></i> Anda harus login kembali saat mengganti data pada akun anda!</strong> data pada keranjang belanja anda juga akan kami kosongkan demi keamanan data anda !
            </div>
          ...
          <div class="alert alert-success" role="alert">
            ...
            <hr>
                ...
                <p>6. Kami akan mengosongkan keranjang belanja anda saat anda mengganti data akun anda.</p>
                <p>7. Berhati hatilah dalam pengisian data akun.</p>
            </div>
          </div>
